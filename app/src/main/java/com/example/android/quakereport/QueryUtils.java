    ...
    public static ArrayList<Quake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                mMagnitude = propertiesObject.optDouble("mag");
                mLocation = propertiesObject.optString("place");
                mTime = propertiesObject.optLong("time");
                earthquakes.add(new Quake(mLocation, mMagnitude, mTime));
            }
